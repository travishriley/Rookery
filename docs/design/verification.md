...
| --- | --- |
| S1 | Existing Windows device/alias exclusions retained; fixed acceptance of a final newline caused by regex `$` semantics. Python and JavaScript probes reject the newline/device cases and accept an ordinary relative path |
